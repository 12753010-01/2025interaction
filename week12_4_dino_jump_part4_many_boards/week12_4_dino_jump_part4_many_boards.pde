...
//修改自week12_2_dino_jump_part2_board_if_dy
//恐龍跳跳跳(3)板子 (4) 卡在板子上
PImage img;
void setup(){
  size(300, 500);
  img = loadImage("dinosaurus.png");
}
float[] boardX = {50,200,100,200}; //float boardX = 200,boardY = 400;
float[] boardY = {100,200,300,400};//把原來的1個變數,變很多個陣列
...
void keyReleased(){
  if(keyCode==LEFT || keyCode==RIGHT)dx=0; //放開,就不要在左右移動了
}
